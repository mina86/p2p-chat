...
%% $Id: ppc.tex,v 1.2 2008/01/21 03:42:48 mina86 Exp $
%%
...
Oto opis poszczególnych plików ¼ród³owych programu:
...
\item[{\it application.cpp}, {\it application.hpp}] definicja
  ...
  programu pompuj±ce sygna³y pomiêdzy modu³ami. :P
...
\item[{\it ui.cpp}, {\it ui.hpp}] modu³ interfejsu u¿ytkownika.  Tutaj
